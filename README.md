...
**First-time HA connection:**
After starting the container, open `http://<host>:1880`, drag in any Home Assistant node, add a server config with:
- URL: `$(HA_URL)`
- Token: `$(HA_TOKEN)`
...
CADDY_IOT_PREFIX=10.30.0
CADDY_ADBLOCK_PREFIX=10.60.0
CADDY_OFFICE_PREFIX=10.10.0

# Home Automation
SLZB06_HOST=10.30.0.X
